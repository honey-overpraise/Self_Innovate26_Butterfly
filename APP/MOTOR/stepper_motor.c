...
void StepperMotor_Init(void) {
    ...
    GPIO_ResetBits(MOTOR_PORT, MOTOR_PIN1 | MOTOR_PIN2 | MOTOR_PIN3 | MOTOR_PIN4);
...
void TIM3_IRQHandler(void) {
    if(TIM_GetITStatus(TIM3, TIM_IT_Update)) {
        ...
        if(isRunning) {
            ...
            // 更新线圈状态
            GPIO_WriteBit(MOTOR_PORT, MOTOR_PIN1, (fullStepSequence[currentStep] & 0x01) ? Bit_SET : Bit_RESET);
            GPIO_WriteBit(MOTOR_PORT, MOTOR_PIN2, (fullStepSequence[currentStep] & 0x02) ? Bit_SET : Bit_RESET);
            GPIO_WriteBit(MOTOR_PORT, MOTOR_PIN3, (fullStepSequence[currentStep] & 0x04) ? Bit_SET : Bit_RESET);
            GPIO_WriteBit(MOTOR_PORT, MOTOR_PIN4, (fullStepSequence[currentStep] & 0x08) ? Bit_SET : Bit_RESET);
